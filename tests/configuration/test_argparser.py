...
class ArgparseTest(unittest.TestCase):
    ...
    def test_identity_merge_parser(self):
        args = self._parse('identity-merge -p azbg_virtual_pos')
        self.assertEqual('identity-merge', args.subparser_name)
        self.assertListEqual(['azbg_virtual_pos'], args.project)
        self.assertEqual(False, args.verbose)

    def test_identity_merge_parser_verbose(self):
        args = self._parse('identity-merge -p azbg_virtual_pos --verbose')
        self.assertEqual('identity-merge', args.subparser_name)
        self.assertListEqual(['azbg_virtual_pos'], args.project)
